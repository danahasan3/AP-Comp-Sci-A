...
public class Card {
    ...
    */
    public boolean matches(Card otherCard){
       boolean matchRank = rank == otherCard.rank;
       boolean matchSuit = suit == otherCard.suit;
       boolean matchPointValue = pointValue == otherCard.pointValue;
       return matchRank && matchSuit && matchPointValue;
    }
